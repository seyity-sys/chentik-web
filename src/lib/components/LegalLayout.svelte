...
<div class="legal-shell">
	...
	<header class="legal-hero" id="top">
		<div class="container">
			<div class="eyebrow"><span class="mark" aria-hidden="true"></span>{page.kicker}</div>
	...
	<main>
		<div class="container">
			<div class="legal-grid">
				...
				<div>
					{#if page.intro}
						<div class="legal-body" style="padding-bottom:0">
					...
					<article class="legal-body">
						{#each page.sections as section, i (section.id)}
							<section id={section.id} class="legal-section">
								<h2 class="legal-h2">
									<span class="legal-h2-num num">{String(i + 1).padStart(2, '0')}</span>
									{section.h}
								</h2>
